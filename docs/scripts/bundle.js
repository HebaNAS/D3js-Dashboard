...
},{"core-js/library/fn/object/define-property":9}],2:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/promise"), __esModule: true };
},{"core-js/library/fn/promise":10}],3:[function(require,module,exports){
"use strict";
...
},{"./_global":27,"./_hide":29,"./_iterators":41,"./_wks":71,"./es6.array.iterator":73}],81:[function(require,module,exports){
...
},{"./models/data":83,"./views/menu-toggle":84}],83:[function(require,module,exports){
'use strict';
				...
				return _regenerator2.default.wrap(function _callee$(_context) {
					while (1) {
						switch (_context.prev = _context.next) {
							case 0:
								mergeDatasets = function mergeDatasets(error, data) {
									...
									var primaryKey = 'Institution code (UKPRN)';
									var foreignKey = 'UKPRN';
									...
									for (var _i = 0; _i < dataset2.length; _i++) {
										for (var j = 0; j < dataset1.length; j++) {
											if (dataset1[j]['Institution code (UKPRN)'] == dataset2[_i].UKPRN) {
												filteredData.push(dataset1[_i]);
											}
										}
									}

									// Create an object with the data and fields we need the final dataset to look like
									var selected = function selected(filteredData, dataset2) {
										return {
									...
									for (var _i2 = 0; _i2 < dataset2.length; _i2++) {
										var row = dataset2[_i2];
									...
									for (var _j = 0; _j < filteredData.length; _j++) {
										var row1 = filteredData[_j];

										// Get the corresponding row from the lookup table
										var row2 = index[row1[primaryKey]];
								...
								return _context.abrupt('return', this.dataset);
...
},{"babel-runtime/helpers/asyncToGenerator":3,"babel-runtime/helpers/classCallCheck":4,"babel-runtime/helpers/createClass":5,"babel-runtime/regenerator":8,"d3":81}],84:[function(require,module,exports){
'use strict';
