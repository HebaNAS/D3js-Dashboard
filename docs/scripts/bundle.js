...
function loadData() {
							...
							dataset[0] = dataManager.loadDataset('../_data/REF2014_Results.csv') || dataManager.loadDataset('https://github.com/HebaNAS/D3js-Dashboard/tree/master/_data/REF2014_Results.csv');
							dataset[1] = dataManager.loadDataset('../_data/learning-providers-plus.csv') || dataManager.loadDataset('https://github.com/HebaNAS/D3js-Dashboard/tree/master/_data/learning-providers-plus.csv');
...
var _loadFilterDatasets = require('./controllers/loadFilterDatasets');

var _loadFilterDatasets2 = _interopRequireDefault(_loadFilterDatasets);
...
// Load datasets
(0, _loadFilterDatasets2.default)();
...
},{"./controllers/loadFilterDatasets":33,"./views/menu-toggle":36,"d3":32}],35:[function(require,module,exports){
'use strict';
...
var DataManager = function () {
	...
	_createClass(DataManager, [{
		key: 'loadDataset',
		value: function loadDataset(path) {
			var d = [];
			try {
