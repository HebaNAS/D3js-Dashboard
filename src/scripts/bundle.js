...
function join(lookupTable, mainTable, mainKey, lookupKey, select) {
...
function startApplication() {
  ...
  d3.queue().defer(d3.csv, 'https://raw.githubusercontent.com/HebaNAS/D3js-Dashboard/master/_data/REF2014_Results.csv').defer(d3.csv, 'https://raw.githubusercontent.com/HebaNAS/D3js-Dashboard/master/_data/learning-providers-plus.csv').await(function (err, mainData, extraData) {
...
},{"./models/data":25,"./views/menu-toggle":26,"d3":22}],25:[function(require,module,exports){
'use strict';
...
var DataManager = function () {
	...
	(0, _createClass3.default)(DataManager, [{
		...
		value: function mergeDatasets(mainData, extraData) {
			...
			// Merge the datasets
			this.dataset = (0, _join2.default)(extraData, mainData, 'Institution code (UKPRN)', 'UKPRN', select);
...
},{"../helpers/join":23,"babel-runtime/helpers/classCallCheck":2,"babel-runtime/helpers/createClass":3,"d3":22}],26:[function(require,module,exports){
'use strict';
